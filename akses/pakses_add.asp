        ...
        <ul class="accordion__description">
          ...
          <li>
            ...
            <ul>
              ...
              <li>
                <%
                data_cmd.commandText = "SELECT AppIDRights FROM DLK_M_AppRight WHERE (Username = '"& data("username") &"') AND (ServerID = '"& data("serverID") &"') and AppIDRights = 'INV1G'"

                set app = data_cmd.execute
                %>
                <input class="form-check-input" type="checkbox" name="INV1G" id="INV1G" <%if app.eof = false then%> checked <%end if%> onClick="updateRights('<%=data("username")%>','<%=data("serverID")%>','INV1G');" >
                <label for="INV1G">Inventory proses</label>
              </li>
              <li>
                <%
                data_cmd.commandText = "SELECT AppIDRights FROM DLK_M_AppRight WHERE (Username = '"& data("username") &"') AND (ServerID = '"& data("serverID") &"') and AppIDRights = 'INV1H'"

                set app = data_cmd.execute
                %>
                <input class="form-check-input" type="checkbox" name="INV1H" id="INV1H" <%if app.eof = false then%> checked <%end if%> onClick="updateRights('<%=data("username")%>','<%=data("serverID")%>','INV1H');" >
                <label for="INV1H">Purchase proses</label>
              </li>
            </ul>
          <!-- incomming -->
          <li>
          ...
          <li>
            ...
            <ul>
              ...
              <li>
                <%
                data_cmd.commandText = "SELECT AppIDRights FROM DLK_M_AppRight WHERE (Username = '"& data("username") &"') AND (ServerID = '"& data("serverID") &"') and AppIDRights = 'INV9G'"

                set app = data_cmd.execute
                %>
                <input class="form-check-input" type="checkbox" name="INV9G" id="INV9G" <%if app.eof = false then%> checked <%end if%> onClick="updateRights('<%=data("username")%>','<%=data("serverID")%>','INV9G');" >
                <label for="INV9G">Ajukan</label>
              </li>
            </ul>
          <!-- revisi bom project -->
          <li>
            ...
            <ul>
              ...
              <li>
                <%
                data_cmd.commandText = "SELECT AppIDRights FROM DLK_M_AppRight WHERE (Username = '"& data("username") &"') AND (ServerID = '"& data("serverID") &"') and AppIDRights = 'INV10G'"

                set app = data_cmd.execute
                %>
                <input class="form-check-input" type="checkbox" name="INV10G" id="INV10G" <%if app.eof = false then%> checked <%end if%> onClick="updateRights('<%=data("username")%>','<%=data("serverID")%>','INV10G');" >
        ...
        <ul class="accordion__description">
          ...
          <li>
            ...
            <ul>
              ...
              <li>
                <%
                data_cmd.commandText = "SELECT AppIDRights FROM DLK_M_AppRight WHERE (Username = '"& data("username") &"') AND (ServerID = '"& data("serverID") &"') and AppIDRights = 'PR3F'"

                set app = data_cmd.execute
                %>
                <input class="form-check-input" type="checkbox" name="PR3F" id="PR3F" <%if app.eof = false then%> checked <%end if%> onClick="updateRights('<%=data("username")%>','<%=data("serverID")%>','PR3F');" >
                <label for="PR3F">Approve memo</label>
              </li>
            </ul>
    ...
    <div class="accordion__item" id="accordion__itempertama">
      ...
      <div class="accordion__content">
        ...
        <!-- penerimaan barang produksi -->
          ...
          <li>
            <%
            data_cmd.commandText = "SELECT AppIDRights FROM DLK_M_AppRight WHERE (Username = '"& data("username") &"') AND (ServerID = '"& data("serverID") &"') and AppIDRights = 'PP9'"

            set app = data_cmd.execute
            %>
            <input class="form-check-input" type="checkbox" name="PP9" id="PP9" <%if app.eof = false then%> checked <%end if%> onClick="updateRights('<%=data("username")%>','<%=data("serverID")%>','PP9');" >
            <label for="PP9">Voucher permintaan</label>
          </li>
            <ul>
              <li>
                <%
                data_cmd.commandText = "SELECT AppIDRights FROM DLK_M_AppRight WHERE (Username = '"& data("username") &"') AND (ServerID = '"& data("serverID") &"') and AppIDRights = 'PP9A'"

                set app = data_cmd.execute
                %>
                <input class="form-check-input" type="checkbox" name="PP9A" id="PP9A" <%if app.eof = false then%> checked <%end if%> onClick="updateRights('<%=data("username")%>','<%=data("serverID")%>','PP9A');" >
                <label for="PP9A">Tambah</label>
              </li>
              <li>
                <%
                data_cmd.commandText = "SELECT AppIDRights FROM DLK_M_AppRight WHERE (Username = '"& data("username") &"') AND (ServerID = '"& data("serverID") &"') and AppIDRights = 'PP9B'"

                set app = data_cmd.execute
                %>
                <input class="form-check-input" type="checkbox" name="PP9B" id="PP9B" <%if app.eof = false then%> checked <%end if%> onClick="updateRights('<%=data("username")%>','<%=data("serverID")%>','PP9B');" >
                <label for="PP9B">Update</label>
              </li>
              <li>
                <%
                data_cmd.commandText = "SELECT AppIDRights FROM DLK_M_AppRight WHERE (Username = '"& data("username") &"') AND (ServerID = '"& data("serverID") &"') and AppIDRights = 'PP9C'"

                set app = data_cmd.execute
                %>
                <input class="form-check-input" type="checkbox" name="PP9C" id="PP9C" <%if app.eof = false then%> checked <%end if%> onClick="updateRights('<%=data("username")%>','<%=data("serverID")%>','PP9C');" >
                <label for="PP9C">Delete</label>
              </li>
              <li>
                <%
                data_cmd.commandText = "SELECT AppIDRights FROM DLK_M_AppRight WHERE (Username = '"& data("username") &"') AND (ServerID = '"& data("serverID") &"') and AppIDRights = 'PP9D'"

                set app = data_cmd.execute
                %>
                <input class="form-check-input" type="checkbox" name="PP9D" id="PP9D" <%if app.eof = false then%> checked <%end if%> onClick="updateRights('<%=data("username")%>','<%=data("serverID")%>','PP9D');" >
                <label for="PP9D">Export</label>
              </li>
            </ul>
        </ul>
      </div>
    ...
    <div class="accordion__item" id="accordion__itemtiga">
      ...
      <div class="accordion__content">
        <ul class="accordion__description">
          ...
          <li>
            <%
            data_cmd.commandText = "SELECT AppIDRights FROM DLK_M_AppRight WHERE (Username = '"& data("username") &"') AND (ServerID = '"& data("serverID") &"') and AppIDRights = 'MQ5'"

            set app = data_cmd.execute
            %>
            <input class="form-check-input" type="checkbox" name="MQ5" id="MQ5" <%if app.eof = false then%> checked <%end if%> onClick="updateRights('<%=data("username")%>','<%=data("serverID")%>','MQ5');" >
            <label for="MQ5">PDI repair</label>
          </li>
            <ul>
              <li>
                <%
                data_cmd.commandText = "SELECT AppIDRights FROM DLK_M_AppRight WHERE (Username = '"& data("username") &"') AND (ServerID = '"& data("serverID") &"') and AppIDRights = 'MQ5A'"

                set app = data_cmd.execute
                %>
                <input class="form-check-input" type="checkbox" name="MQ5A" id="MQ5A" <%if app.eof = false then%> checked <%end if%> onClick="updateRights('<%=data("username")%>','<%=data("serverID")%>','MQ5A');" >
                <label for="MQ5A">Tambah</label>
              </li>
              <li>
                <%
                data_cmd.commandText = "SELECT AppIDRights FROM DLK_M_AppRight WHERE (Username = '"& data("username") &"') AND (ServerID = '"& data("serverID") &"') and AppIDRights = 'MQ5B'"

                set app = data_cmd.execute
                %>
                <input class="form-check-input" type="checkbox" name="MQ5B" id="MQ5B" <%if app.eof = false then%> checked <%end if%> onClick="updateRights('<%=data("username")%>','<%=data("serverID")%>','MQ5B');" >
                <label for="MQ5B">Update</label>
              </li>
              <li>
                <%
                data_cmd.commandText = "SELECT AppIDRights FROM DLK_M_AppRight WHERE (Username = '"& data("username") &"') AND (ServerID = '"& data("serverID") &"') and AppIDRights = 'MQ5C'"

                set app = data_cmd.execute
                %>
                <input class="form-check-input" type="checkbox" name="MQ5C" id="MQ5C" <%if app.eof = false then%> checked <%end if%> onClick="updateRights('<%=data("username")%>','<%=data("serverID")%>','MQ5C');" >
                <label for="MQ5C">Delete</label>
              </li>
              <li>
                <%
                data_cmd.commandText = "SELECT AppIDRights FROM DLK_M_AppRight WHERE (Username = '"& data("username") &"') AND (ServerID = '"& data("serverID") &"') and AppIDRights = 'MQ5D'"

                set app = data_cmd.execute
                %>
                <input class="form-check-input" type="checkbox" name="MQ5D" id="MQ5D" <%if app.eof = false then%> checked <%end if%> onClick="updateRights('<%=data("username")%>','<%=data("serverID")%>','MQ5D');" >
                <label for="MQ5D">Export</label>
              </li>
              <li>
                <%
                data_cmd.commandText = "SELECT AppIDRights FROM DLK_M_AppRight WHERE (Username = '"& data("username") &"') AND (ServerID = '"& data("serverID") &"') and AppIDRights = 'MQ5E'"

                set app = data_cmd.execute
                %>
                <input class="form-check-input" type="checkbox" name="MQ5E" id="MQ5E" <%if app.eof = false then%> checked <%end if%> onClick="updateRights('<%=data("username")%>','<%=data("serverID")%>','MQ5E');" >
                <label for="MQ5E">Upload Document</label>
              </li>
            </ul>
        </ul>
