                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" id="harga" name="harga" class="form-control " value="<%= data("memoharga") %>">
                            </td>
                            <td>
                                <input type="text" id="satuan" name="satuan" class="form-control " value="<%= data("memosatuan") %>">
                            </td>
                            <td>
