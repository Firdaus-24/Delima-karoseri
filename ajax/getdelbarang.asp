...
<% 
    ...
    ' get klaim barang
    data_cmd.commandText = "SELECT DB_ID, DB_IPDIPHID, ISNULL(SUM(DB_QtySatuan),0) AS tklaim FROM dbo.DLK_T_DelBarang WHERE (DB_AktifYN = 'Y') AND (DB_Item = '"& data("brg_ID") &"') GROUP BY DB_ID, DB_IPDIPHID"
    ' response.write data_cmd.commandText & "<br>"
