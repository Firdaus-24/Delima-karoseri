        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="text-center">
                ...
                <a href="aktifd.asp?id=<%= ddata("SJD_ID") %>&p=sjd_u" class="btn badge text-bg-danger" onclick="deleteItem(event,'Detail Nomor Sales Order')">Delete</a>
            </td>
          </tr>
          <% 
