...
<div class="container">
   <div class="row">
      <div class="col-lg-12 mt-3 text-center">
         <h3>DETAIL UPDATE FORM B.O.M</h3>
      </div>
   </div>
   <div class="row">
               ...
               %>
                  <tr>
                     ...
                     <td class="text-center">
                        ...
                        <a href="aktifd.asp?id=<%= barang("BMD_ID") %>&p=bom_u" class="btn badge text-bg-danger" onclick="deleteItem(event,'DELETE DETAIL BOM')">Delete</a>
                     </td>
                  </tr>
               <% 
               barang.movenext
