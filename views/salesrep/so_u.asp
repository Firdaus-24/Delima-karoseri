          ...
          %>
            <tr>
              ...
              <% if session("MK2C") = true then %>
                ...
                <a href="aktifd.asp?id=<%= ddata("ORD_ID") %>&p=so_u" class="btn badge text-bg-danger" onclick="deleteItem(event,'Detail Nomor Sales Order')">Delete</a>
              <% end if %>
              </td>
            </tr>
          <% 
...
<div class="modal fade" id="modalSORepair" tabindex="-1" aria-labelledby="modalSORepairLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <form action="so_u.asp?id=<%= id %>" method="post" onsubmit="validasiForm(this,event,'Tambah Detail Sales Order Repair','warning')">
