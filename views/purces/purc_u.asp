...
<% 
    ...
    data_cmd.commandTExt = "SELECT DLK_T_OrPemH.*, DLK_T_AppPermintaan.AppDana FROM DLK_T_OrPemH LEFT OUTER JOIN DLK_T_AppPermintaan ON DLK_T_OrPemH.OPH_ID = DLK_T_AppPermintaan.appOPHID WHERE OPH_ID = '"& id &"' AND OPH_AktifYN = 'Y'"
