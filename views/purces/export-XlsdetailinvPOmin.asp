    ...
    <table style="text-align:left;width:100%;" id="cdetail">
        ...
        <tbody>
            ...
            <tr>
                ...
                <th id="number"><%= replace(formatCurrency(Round(diskonall)),"$","") %></th>
            </tr>
            <tr>
                <th colspan="6">PPN</th>
                <th><%= data("IPH_PPN") %>%</th>
                <th id="number"><%= replace(formatCurrency(Round(ppn)),"$","") %></th>
            </tr>
            <tr>
                <th colspan="7">Total Pembayaran</th>
                <th id="number"><%= replace(formatCurrency(Round(realgrantotal)),"$","") %></th>
            </tr>
        </tbody>
    </table>
<% 
