      ...
      <table class="table ">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
                <button type="bottom" class="btn btn-light btn-sm" onclick="window.location.href='detailD1.asp?id=<%=ddata("TFK_ID")%>&p=tfkd_add'">Detail</button>
            </td>
          </tr>
          <% 
          response.flush
          ...
          <!-- form tambah d1 -->
          <form action="tfkd_add.asp?id=<%= data("TFK_ID") %>" method="post" onsubmit="validasiForm(this,event,'DETAIL UNIT CUSTOMER','warning')">
          <tr>
            <td>
              <input type="hidden" id="filetype" class="form-control" name="filetype" value="tfkd_add" required>
            ...
            <td>
              <input type="text" id="type" class="form-control" name="type" maxlength="50" required>
            </td>
            <td>
              <input type="text" id="polisi" class="form-control" name="polisi" maxlength="20" required>
            </td>
            <td>
