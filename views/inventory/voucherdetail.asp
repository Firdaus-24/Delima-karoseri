...
<% 
  ...
  if data("VCH_Readyn") = "N" then
    call query("UPDATE DLK_T_VoucherH SET VCH_Readyn = 'Y' WHERE VCH_ID = '"& id &"'")
  end if
  ' detail
...
<div class="container">
  ...
  <div class="row">
    <div class="col-lg-12 text-center mb-3 d-flex justify-content-between">
      <a href="voucher.asp" type="button" class="btn btn-danger">Kembali</a>
    </div>
  </div>
  <div class='row'>
