...
<% 
  ...
  data_cmd.commandText = "SELECT OJH_ID FROM MKT_T_OrjulH WHERE OJH_Agenid = '"& cabang &"' AND OJH_AktifYN = 'Y' AND NOT EXISTS(SELECT IPH_OJHID FROM MKT_T_InvJulNewH WHERE IPH_OJHID = OJH_ID AND IPH_AktifYN = 'Y') ORDER BY OJH_ID ASC"
