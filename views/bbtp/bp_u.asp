...
<% 
  ...
  call header("Update Beban Proses")
%>
<!--#include file="../../navbar.asp"--> 
<div class="container">
  <div class="row">
    <div class="col-lg-12 mt-3 text-center">
      <h3>UPDATE BEBAN PROSES PRODUKSI</h3>
    </div>
  </div>
  <div class="row">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="text-center">
              <a href="aktifd.asp?id=<%= detail("BP_ID") %>&p=bp_u" class="btn badge text-bg-danger" onclick="deleteItem(event,'Detail Beban Proses')">Delete</a>
            </td>
          </tr>
          <% 
          Response.flush
...
<div class="modal fade" id="modalBebanProduksi" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="modalBebanProduksiLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action="bp_u.asp?id=<%= id %>" method="post">
