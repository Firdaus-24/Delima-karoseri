...
<div class="container">
  ...
  <div class="row d-flex justify-content-between generaPictureIncrd">
    <div class="col-md mx-1 mb-3 position-relative generaPictured">
      <form action="uploadGeneralpicture.asp?id=<%= data("IRH_ID")&"A" %>" method="post" onsubmit="validasiGPicture(this)" enctype="multipart/form-data">
    ...
    <div class="col-md mx-1 mb-3 position-relative generaPictured">
      <form action="uploadGeneralpicture.asp?id=<%= data("IRH_ID")&"B" %>" method="post" onsubmit="validasiGPicture(this)" enctype="multipart/form-data">
    ...
    <div class="col-md mx-1 mb-3 position-relative generaPictured">
      <form action="uploadGeneralpicture.asp?id=<%= data("IRH_ID")&"C" %>" method="post" onsubmit="validasiGPicture(this)" enctype="multipart/form-data">
    ...
    <div class="col-md mx-1 mb-3 position-relative generaPictured">
      <form action="uploadGeneralpicture.asp?id=<%= data("IRH_ID")&"D" %>" method="post" onsubmit="validasiGPicture(this)" enctype="multipart/form-data">
    ...
    <div class="col-md mx-1 mb-3 position-relative generaPictured">
      <form action="uploadGeneralpicture.asp?id=<%= data("IRH_ID")&"E" %>" method="post" onsubmit="validasiGPicture(this)" enctype="multipart/form-data">
        ...
        <tbody>
          ...
          %>
            <tr>
              ...
              <td>
              <form action="setdetailomg.asp?id=<%= ddata("IRD_IRHID") %>" method="post" onsubmit="validasiGPicture(this)" enctype="multipart/form-data">
                <div class="position-relative" style="heigth:5rem">
                  <% if ddata("IRD_Img") <> "" then %>
                    <div class="z-n1 position-absolute top-50 start-50 translate-middle">
                      <img src="<%= url %>/views/incunit/img/<%= ddata("IRD_Img") %>.jpg" id="imgDetailIncrd" width="80" height="100">
                    </div>
                    <%if session("MQ4E") = true then%>
                    <div class="position-absolute top-50 start-50 translate-middle">
