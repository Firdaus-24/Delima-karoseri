...
call header("update SalesOrder") %>
  <!--#include file="../../navbar.asp"--> 
  <div class="container">
    <div class="row">
        <div class="col-lg-12 mt-3 text-center">
          <h3>FORM UPDATE SALES ORDER PROJECT</h3>
        </div>
    </div>
    <div class="row">
                    ...
                    <tr>
                      ...
                      <td class="text-center">
                        <%if session("MK1C") = true then%>
                          <a href="aktifd.asp?id=<%= ddata("OJD_OJHID") %>&p=so_u" class="btn badge text-bg-danger" onclick="deleteItem(event,'Detail Nomor Sales Order')">Delete</a>
                        <%else%>
                          -
                        <%end if%>
                      </td>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="so_u.asp?id=<%= id %>" method="post" onsubmit="validasiForm(this,event,'Tambah Detail Sales Order','warning')">
