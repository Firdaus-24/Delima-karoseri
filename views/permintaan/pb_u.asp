...
<% 
    ...
    ' get Barang
    data.commandText = "SELECT Brg_Nama, Brg_ID FROM DLK_M_Barang WHERE Brg_aktifYN = 'Y' AND left(Brg_ID,3) = '"& mdata("memoAgenID") &"' ORDER BY Brg_Nama ASC"
         ...
         <div class="col-lg-12">
            ...
            <div class="row">
                ...
                <div class="col-sm-9 mb-3">
                    <select class="form-select" aria-label="Default select example" name="agen" id="agenpbu" required> 
    ...
    <div class="row dpermintaan">
        ...
        <div class="col-lg-12 mb-3">
            <div class="row">
                ...
                <div class="col-sm-9 mb-3">
                    <div class="pbviewusal">
                        <select class="form-select" aria-label="Default select example" id="brg"  name="brg">
...
if Request.ServerVariables("REQUEST_METHOD") = "POST" then 
    call updateUPbarang()
    if value = 1 then
        call alert("PERMINTAAN BARANG", "berhasil di update", "success","index.asp") 
    elseif value = 2 then
        call alert("PERMINTAAN BARANG", "tidak terdaftar", "warning","index.asp")
    else
        value = 0
    end if
end if
