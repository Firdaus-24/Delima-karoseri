...
<% 
   ...
   ' get jenis satuan
    ...
    call header("Update Transaksi")
%>
<!--#include file="../../navbar.asp"-->
<div class="container">
   <div class="row">
      <div class="col-lg-12  mt-3 text-center">
         <h3>UPDATE TRANSAKSI PENERIMAAN BARANG PRODUKSI</h3>
      </div>
   </div>
   <div class="row">
            ...
            <tbody>
               ...
               <tr>
                  ...
                  <td class="text-center">
                     ...
                     <a href="aktifd.asp?id=<%= ddata("RCD_ID") %>&p=rcd_u" class="btn badge text-bg-danger" onclick="deleteItem(event,'hapus detail transaksi')">Delete</a>
                     <% end if %>
                  </td>
               </tr>
               <% 
...
<div class="modal fade" id="modelrc" tabindex="-1" aria-labelledby="modelrcLabel" aria-hidden="true">
   <div class="modal-dialog modal-dialog-centered">
      ...
      <form action="rcd_u.asp?id=<%= id %>" method="post">
