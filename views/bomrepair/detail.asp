...
'    end if
  ...
  call header("Detail B.O.M Repair") 
%>
...
<div class="container">
  ...
  <div class="row">
    <div class="col-lg-12 mb-3 d-flex justify-content-between ">
      <% if session("PP6D") = true then%>
        <button type="button" class="btn btn-secondary" onclick="window.open('export-xlsbom.asp?id=<%=id%>')">Export</button>
      <%end if%>
