...
<% 
   ...
   ' header
   data_cmd.commandTExt = "SELECT DLK_T_ProduksiH.*, GLB_M_Agen.AgenName, MKT_T_OrJulH.OJH_timework FROM DLK_T_ProduksiH LEFT OUTER JOIN GLB_M_Agen ON DLK_T_ProduksiH.PDH_AgenID = GLB_M_Agen.AgenID LEFT OUTER JOIN MKT_T_OrJulH ON DLK_T_ProduksiH.PDH_OJHID = MKT_T_OrJulH.OJH_ID WHERE PDH_ID = '"& id &"' AND PDH_AktifYN = 'Y'"
...
<div class="container">
   ...
   <form action="prodd_add.asp?id=<%=id%>" method="post" onsubmit="validasiForm(this,event,'UPDATE HEADER PRODUKSI','info')">
   ...
   <div class="modal-dialog">
      <div class="modal-content">
         ...
         <div class="modal-body">
            ...
            <input type="hidden" value="" name="idHeaderProduksi">
            <div class="row">
