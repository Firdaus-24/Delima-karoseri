          ...
          <tr>
            ...
            <td class="text-center">
              <% if session("PP2C") =  true then %>
                ...
                <a href="aktifd.asp?id=<%= ddata("MP_ID") %>&p=mpd_add" class="btn badge text-bg-danger" onclick="deleteItem(event,'Karyawan ManPower')">Delete</a>
                </div>
              <% end if %>
            </td>
          </tr>
...
<div class="modal fade" id="modalManpower" tabindex="-1" aria-labelledby="modalManpowerLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <form action="mpd_add.asp?id=<%= id %>" method="post" onsubmit="validasiForm(this,event,'Detail Manpower','warning')">
