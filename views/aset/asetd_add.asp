                    ...
                    %>
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <a href="aktifd.asp?id=<%= ddata("AD_AsetID") %>&p=asetd_add" class="btn badge text-bg-danger btn-fakturd">Delete</a>
                            </td>
                        </tr>
                    <% 
                    ddata.movenext
...
<div class="modal fade" id="modalAset" tabindex="-1" aria-labelledby="modalAsetLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        ...
        <form action="asetd_add.asp?id=<%= id %>" method="post" id="formaset">
