...
<div class="container">
  <div class="row">
    <div class="col-lg-12 mt-3 text-center">
      <h3>FROM DETAIL RETURN MATERIAL PRODUKSI</h3>
    </div>
  </div>
  <div class="row">
        ...
        %>
          <tr>  
            ...
            <td class="text-center">
              <a href="aktifd.asp?id=<%= ddata("RM_ID") %>&p=rmd_add" class="btn badge text-bg-danger" onclick="deleteItem(event, 'RETURN MATERIAL PRODUKSI')">delete</a>
            </td>
          </tr>
        <% 
        ddata.movenext
...
<div class="modal fade" id="modalReturMaterial" tabindex="-1" aria-labelledby="modalReturMaterialLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action="rmd_add.asp?id=<%= id %>" method="post" onsubmit="validasiReturnMaterial(this,event)">
        <input type="hidden" name="rmid" id="rmid" value="<%= id %>">
        <input type="hidden" name="pdhidrm" id="pdhidrm" value="<%= data("RM_PDHID") %>">
        <input type="hidden" id="hargaRC" class="form-control" name="harga" required>
