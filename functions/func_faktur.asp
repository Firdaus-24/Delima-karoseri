<% 
    ...
    sub tambahDetailFaktur()
        ...
        hargainv = trim(Request.Form("hargainv"))
        ...
        if data.eof then
            ...
            if p.eof then
                ...
                call query("INSERT INTO DLK_T_InvPemD (IPD_IPHID, IPD_Item,IPD_QtySatuan,IPD_Harga,IPD_JenisSat,IPD_Disc1,IPD_Disc2, IPD_RakID) VALUES ('"& iddetail &"','"& ckinv &"',"& qtty &", '"& hargainv &"', '"& satuan &"', '"& disc1 &"', '"& disc2 &"', '"& rak &"') ")
            else
